...
export const IMAN_SUBTOPICS: ImanSubtopic[] = [
  { id: "imn1_01", title: { ur: "تفصیل الدین (ایمان وعمل)", en: "Detail of Deen (Faith & Action)", ar: "تفصيل الدين (الإيمان والعمل)" }, reference: "خطبات حکیم الامت: 48/3", pdfUrl: "https://raw.githubusercontent.com/Chmali15-create/digital-sanctuary/main/public/KHUTBAAT_E_HAKEEM_UL_UMMAT_VOL_03.pdf", pdfPage: 48 },
