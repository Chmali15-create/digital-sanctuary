...
export const IMAN_SUBTOPICS: ImanSubtopic[] = [
  ...
  { id: "imn1_02", title: { ur: "شرط الایمان", en: "Condition of Faith", ar: "شرط الإيمان" }, reference: "خطبات حکیم الامت: 6/176", pdfUrl: "https://github.com/Chmali15-create/digital-sanctuary/releases/download/v3.0/KHUTBAAT_E_HAKEEM_UL_UMMAT_VOL_06_compressed.pdf", pdfPage: 176, pdfPageOffset: 1 },
  ...
  { id: "imn1_25", title: { ur: "ایمان کی قدر و قیمت (حصہ دوم)", en: "Value of Faith (Part 2)", ar: "قيمة الإيمان (الجزء الثاني)" } },
  { id: "imn1_26", title: { ur: "علامت ایمان", en: "Sign of Faith", ar: "علامة الإيمان" } },
  { id: "imn1_27", title: { ur: "علامت ایمان", en: "Sign of Faith", ar: "علامة الإيمان" } },
  { id: "imn1_28", title: { ur: "دولت ایمان (خطاب رمضان)", en: "Wealth of Faith (Ramadan Sermon)", ar: "ثروة الإيمان (خطبة رمضان)" } },
  { id: "imn1_29", title: { ur: "ایمان اور باہمی محبت", en: "Faith and Mutual Love", ar: "الإيمان والمحبة المتبادلة" } },
  { id: "imn1_30", title: { ur: "ایمان کامل کی چار علامتیں", en: "Four Signs of Perfect Faith", ar: "أربع علامات للإيمان الكامل" } },
  { id: "imn1_31", title: { ur: "زبانی ایمان قابل قبول نہیں", en: "Verbal Faith Alone is Not Accepted", ar: "الإيمان اللساني غير مقبول" } },
  { id: "imn1_32", title: { ur: "ایمان کی عظمت", en: "Greatness of Faith", ar: "عظمة الإيمان" } },
  { id: "imn1_33", title: { ur: "ایمانی زندگی کے تقاضے", en: "Demands of a Life of Faith", ar: "مقتضيات الحياة الإيمانية" } },
  { id: "imn1_34", title: { ur: "نفسانی، انسانی اور ایمانی زندگی", en: "Carnal, Human and Faithful Life", ar: "الحياة النفسانية والإنسانية والإيمانية" } },
  { id: "imn1_35", title: { ur: "حصول حیات طیبہ کے مدارج", en: "Stages of Attaining the Pure Life", ar: "مراتب حصول الحياة الطيبة" } },
  { id: "imn1_36", title: { ur: "یقین کامل کی اہمیت", en: "Importance of Complete Certainty", ar: "أهمية اليقين الكامل" } },
  { id: "imn1_37", title: { ur: "تکمیل ایمان", en: "Perfection of Faith", ar: "تكميل الإيمان" } },
  { id: "imn1_38", title: { ur: "ناقص اور کامل انسان", en: "The Imperfect and the Perfect Human", ar: "الإنسان الناقص والكامل" } },
  { id: "imn1_39", title: { ur: "اہمیت ایمان", en: "Importance of Faith", ar: "أهمية الإيمان" } },
  { id: "imn1_40", title: { ur: "من قال لا الہ الا اللہ دخل الجنۃ", en: "Whoever Says La ilaha illallah Enters Paradise", ar: "من قال لا إله إلا الله دخل الجنة" } },
  { id: "imn1_41", title: { ur: "ایمان کی شیرینی", en: "Sweetness of Faith", ar: "حلاوة الإيمان" } },
  { id: "imn1_42", title: { ur: "عقل سلیم اور ایمان باللہ: قیامت کی ہولناکی", en: "Sound Reason & Belief in Allah: Horrors of Qiyamah", ar: "العقل السليم والإيمان بالله: أهوال القيامة" } },
  { id: "imn1_43", title: { ur: "باایمان زندگی اور خدائی مدد", en: "Faithful Life and Divine Help", ar: "الحياة الإيمانية والمعونة الإلهية" } },
  { id: "imn1_44", title: { ur: "بندوں کی حفاظت کے لیے اللہ تعالی کا عملہ", en: "Allah's Staff Protecting His Servants", ar: "ملائكة الله لحفظ العباد" } },
  { id: "imn1_45", title: { ur: "قانون الہی پر عمل پیرا ہونے کا نام ایمان ہے", en: "Faith is Acting Upon Divine Law", ar: "الإيمان هو العمل بالقانون الإلهي" } },
  { id: "imn1_46", title: { ur: "بنیادی عقائد", en: "Fundamental Beliefs", ar: "العقائد الأساسية" } },
  { id: "imn1_47", title: { ur: "مفہوم و اقسام ایمان", en: "Meaning and Types of Faith", ar: "مفهوم وأنواع الإيمان" } },
  { id: "imn1_48", title: { ur: "اللہ پر ایمان (صفات الٰہی)", en: "Belief in Allah (Divine Attributes)", ar: "الإيمان بالله (الصفات الإلهية)" } },
  { id: "imn1_49", title: { ur: "فرشتوں پر ایمان", en: "Belief in Angels", ar: "الإيمان بالملائكة" } },
  { id: "imn1_50", title: { ur: "آسمانی کتابوں پر ایمان", en: "Belief in Heavenly Books", ar: "الإيمان بالكتب السماوية" } },
  { id: "imn1_51", title: { ur: "ایمانیات پر ایک مجموعی نظر", en: "Overview of Beliefs (Imaniyat)", ar: "نظرة عامة على الإيمانيات" } },
];
