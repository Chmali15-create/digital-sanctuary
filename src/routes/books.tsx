...
function BooksIndex() {
  return (
    <div className="relative min-h-screen">
      <AmbientBackground />
      <BackBar to="/" label="Books" eyebrow="Section I — The Library" />
      <main className="relative z-10 mx-auto max-w-6xl px-5 pb-24 pt-12 sm:px-8">
        <header className="mb-12 max-w-2xl animate-fade-up">
          <h2 className="font-serif text-4xl text-foreground sm:text-5xl">
            The <span className="text-gradient-gold italic">index</span> of topics
          </h2>
          <p className="mt-4 text-muted-foreground">
            Choose a subject to reveal the works gathered beneath it.
          </p>
        </header>
